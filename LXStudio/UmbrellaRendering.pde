...
public class UIRadiaLumia extends UI3dComponent {
  ...
  public void onDraw (UI ui, PGraphics pg) {
    ...
    for (GeodesicModel3D.Bloom b : structureModel.radiaLumia.blooms) {
		numberDrawn += 1;
		if (numberDrawn >= structureModel.radiaLumia.blooms.length)
			continue;
      ...
      final PVector directionB = new PVector(b.bloomCenter.x, b.bloomCenter.y, b.bloomCenter.z);
	  ...
	  */
	  ...
	  int neighborCount = GeodesicModel3D.hub_graph[b.index].length;
  ...
  public float GetRotationAroundSpikeAxis (PGraphics pg, GeodesicModel3D.Bloom b) {
...
public void testUmbrellaTransformCode () {
		...
		PVector up = LXToPVector(b.bloomCenter);
